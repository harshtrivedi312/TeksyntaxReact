  ...
  return (
    ...
    <div className="container mt-5">
      ...
      <h4 style={{ color: "#FFCB68" }}>
        <strong>
          Master the fundamental skills of a React Development in just a few
          weeks
        </strong>
      </h4>
      <div className="row">
          ...
          <div className="card">
            <div className="card-body">
              <h5 className="card-title">
                Learn Web Application fundamentals and databases
              </h5>
              <p className="card-text">
                Grasp programming foundations, write robust code with
                javaScript and TypeScript programming and build Scalable web App from
                scratch. Master relational databases and SQL.
              </p>
            </div>
            <div className="card-footer d-flex justify-content-between">
              <i className="fa-brands fa-npm fa-xl p-2"></i>
              <i className="fa-brands fa-node fa-xl p-2"></i>
              <i className="fa-brands fa-js fa-xl p-2"></i>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                Master modern JavaScript and use key frameworks, like React .
              </p>
            </div>
            <div className="card-footer d-flex justify-content-between">
        ...
        <div className="col-md-6 mb-4">
          <div className="card">
            ...
            <div className="card-footer d-flex justify-content-between">
              <i className="fa-brands fa-hashnode fa-xl p-2"></i>
